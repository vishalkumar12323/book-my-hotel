...
const Footer = () => {
  return (
    <footer className="bg-blue-600 p-4 md:p-8 tracking-wide mt-auto">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-xl mb-6 text-white">Useful links</h4>
          ...
          <div>
            <h4 className="text-xl mb-6 text-white">Information</h4>
            <ul className="space-y-4 pl-2">
              <li>
                <Link
                  to="javascript:void(0)"
        ...
        <p className="text-gray-100 text-xl mt-10">
