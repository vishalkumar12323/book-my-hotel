...
const Footer = () => {
  return (
    <footer className="bg-blue-600 p-4 md:p-6 tracking-wide mt-auto">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-7">
          ...
          <div>
            <h4 className="text-[16px] md:text-[18px] mb-6 text-white">
              Useful links
            </h4>
            <ul className="space-y-4 pl-2">
              <li>
                <Link
                  ...
                  className="text-white hover:text-gray-200 text-[13px] md:text-[15px]"
                >
                  Home
                </Link>
              </li>
        ...
        <p className="text-gray-100 text-[16px] md:text-[18px] mt-10">
          © BookMyHotel. All rights reserved.
        </p>
      </div>
    </footer>
  );
